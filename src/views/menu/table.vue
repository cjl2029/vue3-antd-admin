...
export default defineComponent({
  ...
  setup () {
    ...
    // 列表
    const columns = [ 
      { title: '序号', dataIndex: 'id' }, { title: '名称', dataIndex: 'name' }, {  title: 'icon', dataIndex: 'icon' },
      { title: '跳转', dataIndex: 'redirect' }, { title: '路径', dataIndex: 'path' },
      { title: 'key', dataIndex: 'key' }, { title: 'component', dataIndex: 'component' },
